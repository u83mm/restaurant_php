<form class="mb-5" action="/reservations/reservation/save" method="post">    
    ...
    <div class="row mb-0 mb-md-3">
        <div class="col-12 col-md-6">
            ...
            <div class="col-8 col-md-5 d-inline-block mb-2 mb-md-0">
                <input class="form-control blockBefore" type="date" name="date" id="date" value="<?php if(isset($date)) echo $date; ?>" required>
            </div> 
        </div>
        <div class="col-12 col-md-6">
    ...
    <div class="row mb-0 mb-md-3">       
        <div class="col-12 col-md-6">
            ...
            <div class="col-8 col-md-7 d-inline-block mb-2 mb-md-0">
                <input class="form-control" type="text" name="name" id="name" value="<?php if(isset($name)) echo $fields['name']; ?>" required>
            </div>        
        </div>        
        <div class="col-12 col-md-6">
    ...
    <div class="row mb-0 mb-md-3">       
        <div class="col-12">
            ...
            <div class="col-12 col-md-9 d-md-inline-block">
                <textarea class="form-control" name="comment" id="comment" rows="5" placeholder="<?php echo ucfirst($home->language['write_comment']); ?>"><?php if(isset($comment)) echo $comment; ?></textarea> 
            </div>
