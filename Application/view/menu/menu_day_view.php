    ...
    <div class="row mb-3">
        ...
        <ul class="ps-4">
            <?php foreach ($menuDaySections['main'] as $key => $plato) { ?>                
                <li><em><a href="/menu/showDisheInfo/<?php echo $plato['dishe_id']; ?>"><?php echo ucfirst($plato['name']); ?></a></em></li>
            <?php } ?>
        </ul>
    </div>
    <div class="row mb-3">
    ...
    <div class="row mb-3">
        ...
        <ul class="ps-4">
            <?php foreach ($menuDaySections['dessert'] as $key => $postre) { ?>
                <li><em><a href="/menu/showDisheInfo/<?php echo $postre['dishe_id']; ?>"><?php echo ucfirst($postre['name']); ?></a></em></li>
            <?php } ?>
        </ul>
    </div>
    <hr>
