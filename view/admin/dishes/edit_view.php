...
?>
    ...
    <div class="col-12 col-md-9 col-lg-7 col-xl-6 mx-auto">
        ...
        <form action="#" method="post" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                <label class="col-12 col-md-3 text-center text-md-end col-form-label" for="description"><?php echo ucfirst($page->language['description']); ?>:</label>
                <div class="col-sm-8">
                    <textarea class="form-control"name="description" id="description" cols="30" rows="10" required><?php echo $dishe['description']; ?></textarea>                    
                </div>                
            </div>
            <div class="row mb-3">
                <label class="col-12 col-md-3 text-center text-md-end col-form-label" for="price"><?php echo ucfirst($page->language['price']); ?>:</label>
                <div class="col-sm-2">
                    <input class="form-control" type="number" step="0.01" min="0" max="5000" name="price" id="price" value="<?php echo $dishe['price']; ?>" required>
                </div>                
            </div>
            <div class="row mb-3">
                <label class="col-12 col-md-3 text-center text-md-end col-form-label" for="category"><?php echo ucfirst($page->language['category']); ?>:</label>
            ...
            <div class="row mb-3">
                <label class="col-12 col-md-3 text-center text-md-end col-form-label" for="dishes_type"><?php echo ucfirst($page->language['dish_type']); ?>:</label>
                <div class="col-12 col-md-8 text-center text-md-start">
