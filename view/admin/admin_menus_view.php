...
?>
    ...
    <div class="row mb-4">
        ...
        <div class="col-12 col-md-6 col-lg-4 mb-4">
            ...
            <div class="w-100 col-3 bg-success bg-opacity-10 adminMenus">
                <form action="/admin/admin_reservations.php" method="post"><button type="submit" class="btn btn-primary mb-5 d-inline-block" name="action" value="search_panel"><?php echo ucfirst($page->language['reservations']); ?></button></form>
            </div>
        </div>
                                            <!-- NEW SECTION -->
